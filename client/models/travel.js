import { query, create, update, remove, changeStatus } from '../services/travel'
  ...
  effects: {
    ...
    *'delete'({ payload }, { call, put, select }) {
      ...
      if (result && result.success) {
        const conditions = yield select((state) => state.travel.conditions);
    ...
    *update({ payload }, { select, call, put }) {
      yield put({ type: 'hideModal' })
      yield put({ type: 'showLoading' })
      const id = yield select((state) => state.travel.currentItem.ID)
